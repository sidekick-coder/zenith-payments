...
//#region modules/mod/client/components/GatewayCustomers.vue?vue&type=script&setup=true&lang.ts
var GatewayCustomers_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function sync() {
			syncing.value = true;
			const [error] = await $fetch.try(`/api/zpayments/gateways/${props.gateway.id}/customers/sync`, { method: "POST" });
			if (error) {
				syncing.value = false;
				return;
			}
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(ssrRenderComponent(unref(CardTitle), null, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(_ctx.$t("Customers"))}`);
											else return [createTextVNode(toDisplayString(_ctx.$t("Customers")), 1)];
										}),
										_: 1
									}, _parent, _scopeId));
									_push(ssrRenderComponent(unref(CardDescription), null, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(_ctx.$t("Manage customers associated with this gateway."))}`);
											else return [createTextVNode(toDisplayString(_ctx.$t("Manage customers associated with this gateway.")), 1)];
										}),
										_: 1
									}, _parent, _scopeId));
									...
									createVNode(unref(CardTitle), null, {
										default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Customers")), 1)]),
										_: 1
									}),
									createVNode(unref(CardDescription), null, {
										default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Manage customers associated with this gateway.")), 1)]),
										_: 1
									}),
...
var _sfc_setup = GatewayCustomers_vue_vue_type_script_setup_true_lang_default.setup;
GatewayCustomers_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
...
var GatewayCustomers_default = GatewayCustomers_vue_vue_type_script_setup_true_lang_default;
//#endregion
export { GatewayCustomers_default as default };
