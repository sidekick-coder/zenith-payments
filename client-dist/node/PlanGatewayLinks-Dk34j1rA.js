...
var PlanGatewayLinks_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(CardHeader, null, {
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<div class="flex items-center justify-between"${_scopeId}><div${_scopeId}>`);
									_push(ssrRenderComponent(CardTitle, null, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(_ctx.$t("Linked Gateways"))}`);
											else return [createTextVNode(toDisplayString(_ctx.$t("Linked Gateways")), 1)];
										}),
										_: 1
									}, _parent, _scopeId));
									_push(ssrRenderComponent(CardDescription, null, {
										default: withCtx((_, _push, _parent, _scopeId) => {
											if (_push) _push(`${ssrInterpolate(_ctx.$t("Payment gateways linked to this plan"))}`);
											else return [createTextVNode(toDisplayString(_ctx.$t("Payment gateways linked to this plan")), 1)];
										}),
										_: 1
									}, _parent, _scopeId));
									_push(`</div>`);
									...
									_push(`</div>`);
								} else return [createVNode("div", { class: "flex items-center justify-between" }, [createVNode("div", null, [createVNode(CardTitle, null, {
									default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Linked Gateways")), 1)]),
									_: 1
								}), createVNode(CardDescription, null, {
									default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Payment gateways linked to this plan")), 1)]),
									_: 1
						...
						_push(ssrRenderComponent(CardContent, null, {
							default: withCtx((_, _push, _parent, _scopeId) => {
						...
						default: withCtx(() => [createVNode("div", { class: "flex items-center justify-between" }, [createVNode("div", null, [createVNode(CardTitle, null, {
							default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Linked Gateways")), 1)]),
							_: 1
						}), createVNode(CardDescription, null, {
							default: withCtx(() => [createTextVNode(toDisplayString(_ctx.$t("Payment gateways linked to this plan")), 1)]),
...
//#endregion
//#region modules/mod/client/components/PlanGatewayLinks.vue
var _sfc_setup = PlanGatewayLinks_vue_vue_type_script_setup_true_lang_default.setup;
PlanGatewayLinks_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
...
var PlanGatewayLinks_default = PlanGatewayLinks_vue_vue_type_script_setup_true_lang_default;
//#endregion
export { PlanGatewayLinks_default as default };
