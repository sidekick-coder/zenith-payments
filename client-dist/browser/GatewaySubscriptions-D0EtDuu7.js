...
var C = /* @__PURE__ */ i({
	...
	setup(i) {
		...
		async function T() {
			x.value = !0;
			let [e] = await b.try(`/api/zpayments/gateways/${v.gateway.id}/subscriptions/sync`, { method: "POST" });
			if (e) {
				x.value = !1;
				return;
			}
			d.success($t("Subscriptions synced successfully.")), setTimeout(() => {
				x.value = !1;
			}, 1e3);
		}
		async function E() {
		...
		return (s, d) => (o(), t(l(f), null, {
			default: u(() => [r(l(g), null, {
				default: u(() => [
					r(l(_), null, {
						default: u(() => [n(c(s.$t("Subscriptions")), 1)]),
						_: 1
					}),
					r(l(h), null, {
						default: u(() => [n(c(s.$t("Manage subscriptions associated with this gateway.")), 1)]),
						_: 1
					}),
