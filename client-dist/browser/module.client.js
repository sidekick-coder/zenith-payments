...
class c extends p {
  async onRegister() {
    for (const [e, a] of Object.entries(/* @__PURE__ */ Object.assign({ "./components/GatewayConfig.vue": () => import("./GatewayConfig-C_LP4r90.js"), "./components/GatewayCustomers.vue": () => import("./GatewayCustomers-C7GU7PDc.js"), "./components/GatewayEntityTable.vue": () => import("./GatewayEntityTable-BZ3-nDbO.js"), "./components/GatewaySubscriptions.vue": () => import("./GatewaySubscriptions-BN-3319F.js"), "./components/PlanGatewayLinks.vue": () => import("./PlanGatewayLinks-yOimmSNP.js"), "./components/ProductMetasTable.vue": () => import("./ProductMetasTable-Bgbd8ppy.js"), "./components/ProductPaymentsTable.vue": () => import("./ProductPaymentsTable-BD51O23i.js"), "./components/ProductPricesTable.vue": () => import("./ProductPricesTable-BFmMmiqU.js"), "./components/UserOrdersCard.vue": () => import("./UserOrdersCard-HsecrrRx.js"), "./components/UserOrdersPage.vue": () => import("./UserOrdersPage-NSup5URu.js"), "./components/UserOrdersTable.vue": () => import("./UserOrdersTable-C3hbm4k-.js"), "./components/UserPaymentsTable.vue": () => import("./UserPaymentsTable-CsZUVj9Y.js"), "./layouts/GatewayLayout.vue": () => import("./GatewayLayout-D5oNKtOo.js") }))) {
  ...
  async onLoad() {
    const e = d();
    s.auto(/* @__PURE__ */ Object.assign({ "./pages/admin/gateway-entities/index.vue": () => import("./index-B-7MmZOD.js"), "./pages/admin/gateways/[id].vue": () => import("./_id_-ZVdQDwOo.js"), "./pages/admin/gateways/index.vue": () => import("./index-B1dcNH65.js"), "./pages/admin/orders/index.vue": () => import("./index-Cx9_0lhj.js"), "./pages/admin/payments/index.vue": () => import("./index-CtMPJkFW.js"), "./pages/admin/products/[id].vue": () => import("./_id_-DTRSTO2P.js"), "./pages/admin/products/index.vue": () => import("./index-BZDBxt0d.js"), "./pages/admin/users/[id].vue": () => import("./_id_-CP6ciPO8.js"), "./pages/admin/users/index.vue": () => import("./index-cMWPBI5e.js") }), {
      strip: ["pages", "admin"],
      guards: [m],
      prefix: "/admin/zpayments"
    }), s.auto(/* @__PURE__ */ Object.assign({ "./pages/admin/gateway-entities/index.vue": () => import("./index-B-7MmZOD.js"), "./pages/admin/gateways/[id].vue": () => import("./_id_-ZVdQDwOo.js"), "./pages/admin/gateways/index.vue": () => import("./index-B1dcNH65.js"), "./pages/admin/orders/index.vue": () => import("./index-Cx9_0lhj.js"), "./pages/admin/payments/index.vue": () => import("./index-CtMPJkFW.js"), "./pages/admin/products/[id].vue": () => import("./_id_-DTRSTO2P.js"), "./pages/admin/products/index.vue": () => import("./index-BZDBxt0d.js"), "./pages/admin/users/[id].vue": () => import("./_id_-CP6ciPO8.js"), "./pages/admin/users/index.vue": () => import("./index-cMWPBI5e.js"), "./pages/result.vue": () => import("./result-DSHBKVKK.js") }), {
      strip: ["pages"],
      exclude: ["/admin/**"],
      prefix: "/zpayments"
    }), s.addRoute({
