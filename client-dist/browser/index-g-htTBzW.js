...
const d = await globalThis.importAsync("#client/components/PageTitle.vue"), T = d.default || d, r = await globalThis.importAsync("#client/components/PageSubtitle.vue"), h = r.default || r;
    ...
    return y([
      ...
      default: e(() => [
        ...
        a(A, {
          ...
          ref: u,
          loading: l.value,
          "onUpdate:loading": i[0] || (i[0] = (p) => l.value = p)
        }, null, 8, ["loading"])
      ]),
      _: 1
    }));
